...
void
	assign_enemys_stats(t_custom_game *game, t_enemy *enemy, char type)
{
...
static int
	copy_mob_to_scene(t_env *env, t_map *map, t_map *mob, t_enemy *enemy)
{
	t_mesh		new;
	t_mesh		*m;
	int			i;
...
int
	create_mob(t_env *env, t_map *map, char type, t_vec3d pos)
{
	t_enemy	enemy;
