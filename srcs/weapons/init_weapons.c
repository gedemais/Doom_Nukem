...
static void		assign_meshs(t_env *env)
{
	...
	env->weapons[W_FAMAS].charger = dyacc(env->maps[SCENE_FAMAS].meshs.c, 1);
	env->weapons[W_FAMAS].breech = dyacc(env->maps[SCENE_FAMAS].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_FAMAS].mesh->name);
	...
	env->weapons[W_AK47].breech = dyacc(env->maps[SCENE_AK47].meshs.c, 1);
	env->weapons[W_AK47].charger = dyacc(env->maps[SCENE_AK47].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_AK47].mesh->name);
	...
	env->weapons[W_SAWED_OFF].breech = dyacc(env->maps[SCENE_SAWED_OFF].meshs.c, 1);
...
//	printf("%s\n", env->weapons[W_SAWED_OFF].mesh->name);
	...
	env->weapons[W_GLOCK_18].charger = dyacc(env->maps[SCENE_GLOCK_18].meshs.c, 1);
	env->weapons[W_GLOCK_18].breech = dyacc(env->maps[SCENE_GLOCK_18].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_GLOCK_18].mesh->name);
	...
	env->weapons[W_AUG].charger = dyacc(env->maps[SCENE_AUG].meshs.c, 1);
	env->weapons[W_AUG].breech = dyacc(env->maps[SCENE_AUG].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_AUG].mesh->name);
	...
	env->weapons[W_UMP45].charger = dyacc(env->maps[SCENE_UMP45].meshs.c, 1);
	env->weapons[W_UMP45].breech = dyacc(env->maps[SCENE_UMP45].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_UMP45].mesh->name);
	...
	env->weapons[W_MAG7].breech = dyacc(env->maps[SCENE_MAG7].meshs.c, 1);
	env->weapons[W_MAG7].charger = dyacc(env->maps[SCENE_MAG7].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_MAG7].mesh->name);
	...
	env->weapons[W_GALIL].charger = dyacc(env->maps[SCENE_GALIL].meshs.c, 1);
	env->weapons[W_GALIL].breech = dyacc(env->maps[SCENE_GALIL].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_GALIL].mesh->name);
	...
	env->weapons[W_NEGEV].charger = dyacc(env->maps[SCENE_NEGEV].meshs.c, 1);
	env->weapons[W_NEGEV].breech = dyacc(env->maps[SCENE_NEGEV].meshs.c, 2);
...
//	printf("%s\n", env->weapons[W_NEGEV].mesh->name);
	...
	env->weapons[W_TEC9].charger = dyacc(env->maps[SCENE_TEC9].meshs.c, 1);
	env->weapons[W_TEC9].breech = dyacc(env->maps[SCENE_TEC9].meshs.c, 2);
