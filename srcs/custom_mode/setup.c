...
static void	init_game_over_buttons(t_env *env)
{
	...
	b->r_down = (t_point){600 + env->sprites[SP_YES_ON].wdt, 500 + env->sprites[SP_YES_ON].hgt};
	...
	b->r_down = (t_point){200 + env->sprites[SP_NO_ON].wdt, 500 + env->sprites[SP_NO_ON].hgt};
}
